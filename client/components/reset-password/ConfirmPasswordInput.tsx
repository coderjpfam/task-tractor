...
import type { ConfirmPasswordInputProps } from '@/types/reset-password.types';

export default function ConfirmPasswordInput({ value, onChange, error, isDark }: ConfirmPasswordInputProps) {
